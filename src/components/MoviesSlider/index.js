...
import {ActionMovie, ComedyMovie} from '../MovieItem'
  ...
  return (
    <div className="slider-container">
      <div className="movie-slider">
        ...
        <Slider {...settings}>
          {getActionMovies().map(eachMovie => (
            <ActionMovie actionMovies={eachMovie} key={eachMovie.id} />
          ))}
        </Slider>
      </div>
      <div className="movie-slider">
        ...
        <Slider {...settings}>
          {getComedyMovies().map(eachMovie => (
            <ComedyMovie comedyMovies={eachMovie} key={eachMovie.id} />
          ))}
        </Slider>
      </div>
    </div>
